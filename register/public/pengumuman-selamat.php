<section id="selamat" class="flex flex-1 w-full justify-center items-center rounded-lg">
    <div class="w-full max-w-4xl bg-white rounded-lg shadow-lg flex flex-col items-center">
        ...
        <div class="p-8 border-b border-gray-300 w-full text-center">
            <h1 class="text-4xl font-bold">Selamat, Kamu Diterima!</h1>
        </div>
                ...
                <div class="flex flex-col items-center">
                    <div class="mb-4">
                        <p class="text-gray-600 w-full text-center mb-6">
                            ...
                            seleksi dan diterima sebagai anggota IDM dalam posisi <span
                                class="font-bold"><?php echo htmlspecialchars($user['sebagai']); ?></span>. Kami sangat
                            senang menyambutmu! Segera
        ...
        <div class="p-4 mt-6">
            <a href="https://chat.whatsapp.com/CtvUgNcIzje1FHFmDFye9a" target="_blank"
