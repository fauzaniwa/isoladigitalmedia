...
if (isset($_GET['status'])) {
    ...
    if ($status == 'success') {
        echo "<script>alert('Berhasil update data artbooth!');</script>";
    } elseif ($status == 'error') {
        echo "<script>alert('Gagal menambahkan artbooth!');</script>";
    } elseif ($status == 'deleted') {
        echo "<script>alert('Berhasil menghapus data artbooth!');</script>";
    } elseif ($status == 'error_delete') {
        echo "<script>alert('Gagal menghapus artbooth!');</script>";
    } elseif ($status == 'invalid_request') {
        echo "<script>alert('Gagal menambahkan artbooth! Invalid Request');</script>";
...
<head>
    ...
    <title>Art & Photobooth - IDM</title>
        ...
        <div class="flex flex-col flex-1">
            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    ...
                    // Query SQL untuk mengambil data dari tabel photobooth
                            ...
                            <table class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr
                                        ...
                                        <th class="px-4 py-3">Style Art</th>
                                        <th class="px-4 py-3">Frame Type</th>
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3 text-sm">
                                                <?php echo htmlspecialchars($row['style_art']); ?>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <?php echo htmlspecialchars($row['frame_type']); ?>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <?php echo htmlspecialchars($row['total_order']); ?>
                                            </td>
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-4 text-sm">
                                                    <!-- Edit Button -->
                                                    <a href="edit_photobooth?id=<?php echo htmlspecialchars($row['id_photobooth']); ?>"
                                                    ...
                                                    <!-- Delete Button -->
                                                    <form method="GET" action="../controllers/delete_photobooth.php"
                                                        onsubmit="return confirm('Are you sure you want to delete this item?');">
                                                        <input type="hidden" name="id"
                                                            value="<?php echo htmlspecialchars($row['id_photobooth']); ?>">
                                                        <button type="submit"
